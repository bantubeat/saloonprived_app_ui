...
class AttentionPageScreen extends StatefulWidget {
  const AttentionPageScreen({super.key});

  @override
  State<AttentionPageScreen> createState() => _AttentionPageScreenState();
}

class _AttentionPageScreenState extends State<AttentionPageScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final buttonTextSize = screenSize.width <= 375 && screenSize.height <= 667 ? 14.0 : 16.0;
