...
class PaidConnectedUserSaloonNoAccessScreen extends StatelessWidget {
  const PaidConnectedUserSaloonNoAccessScreen({super.key});
        ...
        child: Column(
          children: [
            ...
            Container(
              color: Colors.white,
              child: const TabBar(
                labelColor: Color.fromRGBO(143, 139, 139, 1),
